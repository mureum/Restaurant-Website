...
const client = new Client({
  connectionString: 'postgresql://3adm19ntb:v2_3zT39_RyphETydAGnFAvAfNXCAxBu@db.bit.io:5432/3adm19ntb/waiter_calls'
});
...
async function insertOrder(order) {
  const query = {
    text: 'INSERT INTO waiter_calls(table_no, order_no, customer_name, time, order_description) VALUES($1, $2, $3, $4, $5)',
    values: [order.tableNumber, order.orderNumber, order.customerName, order.time, order.details]
  };
